...
const watchComponent: React.FC<watchComponentProps> = ({user})  => {
    return (
        <div className="group before:absolute before:bg-[#0AA8A7] before:w-3 before:h-12 before:top-24 before:-right-2 before:-z-10 before:rounded-2xl before:shadow-inner before:shadow-gray-50 relative w-60 h-60 bg-[#0AA8A7] shadow-inner shadow-gray-50 flex justify-center items-center rounded-3xl">
            <div className="w-56 h-56 bg-neutral-900 shadow-inner shadow-gray-50 flex justify-center items-center rounded-3xl">
                ...
                <div className="group-hover:duration-300 hover:opacity-100  opacity-0 before:absolute before:w-12 before:h-12 before:bg-orange-800 before:rounded-full before:blur-xl before:top-16 relative   flex flex-col justify-around items-center w-44 h-40 bg-neutral-900 text-gray-50">
                    ...
                    <span className="z-10 flex items-center text-3xl text-[#0AA8A7] [text-shadow:_2px_2px_#fff,_1px_2px_#fff]">0.000000</span>
